...
+ (y > 0 ? ' py-4 bg-slate-950 border-violet-950' : ' py-6 bg-transparent border-transparent')}">
    <h1 class="font-medium">
        <b class="font-bold poppins">I Putu Krisna Dharma Saputra</b>
    </h1>
    ...
    <a href="https://www.linkedin.com/in/i-putu-krisna-dharma-saputra-01084014b/" target="_blank" class="blueShadow relative overflow-hidden px-5 py-2 group rounded-full bg-white text-slate-950">
